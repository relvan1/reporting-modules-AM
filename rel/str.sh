...
gcloud container clusters create $clusterName --zone $zoneSelect --num-nodes=1 --machine-type=n1-standard-8 --image-type=ubuntu --node-labels=type=jmeter
...
do
	...
	read -p "Do you want to run Single-Region Test (or) Multi-Region Test [S/M]: " testType
		...
		read -p "Select the Location: " Location
done
